...
const ResetAdmin = ({ selectedData }: { selectedData: Admin }) => {
    ...
    const handleSubmit = async (e: FormEvent) => {
        try {
            ...
            const url = `${process.env.NEXT_PUBLIC_BASE_API_URL}/admins/${selectedData.id}/reset-password`;
            ...
            console.log("Reset admin password response:", result);

            if (result?.success) {
                toast.success(result?.message || "Password admin berhasil diperbarui");
                setOpen(false);
                setLoading(false);
        ...
        <AlertDialog open={open} onOpenChange={setOpen}>
            ...
            <AlertDialogContent>
                <form onSubmit={handleSubmit}>
                    <AlertDialogHeader>
                        <AlertDialogTitle>Ubah Password Admin</AlertDialogTitle>
                    </AlertDialogHeader>
